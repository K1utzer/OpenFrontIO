...
const unitOptions: { type: UnitType; translationKey: string }[] = [
  ...
  { type: UnitType.MissileShip, translationKey: "unit_type.missile_ship" },
  ...
  { type: UnitType.ClusterRocket, translationKey: "unit_type.cluster_rocket" },
  {
    type: UnitType.TacticalRocket,
    translationKey: "unit_type.tactical_rocket",
  },
